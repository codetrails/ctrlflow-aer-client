...
If you are developing a *Java application* that uses the popular http://logback.qos.ch/[*Logback*] logging framework, you can configure it to use the Ctrlflow AER Logback Client to send any logged errors to your server.
+
*Examples* on how to use this client are maintained in a https://github.com/codetrails/ctrlflow-aer-client-examples[separate project].
